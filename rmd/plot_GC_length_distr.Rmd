...
```{r}
contigs.n <- read.delim('/Users/pavel/Desktop/PROJECTS/after_long_break/GC_R/contigs_N_tab.tsv', header = F,  sep="\t", stringsAsFactors = F)
names(contigs.n) = c("contig", "length", "mean.coverage", "repr", "unit.seq")
contigs.n <- contigs.n %>% drop_na()

contigs.v <- read.delim('/Users/pavel/Desktop/PROJECTS/after_long_break/GC_R/contigs_V_tab.tsv', header = F,  sep="\t", stringsAsFactors = F) 
names(contigs.v) = c("contig", "length", "mean.coverage", "repr", "unit.seq")
contigs.v <- contigs.v %>% drop_na()

all.repeats.n <- read.delim('/Users/pavel/Desktop/PROJECTS/after_long_break/GC_R/N_all_tab_bycol.tsv', header = F,  sep="\t", stringsAsFactors = F) 
names(all.repeats.n) = c("contig", "length", "mean.coverage", "repr", "unit.seq")

all.repeats.v <- read.delim('/Users/pavel/Desktop/PROJECTS/after_long_break/GC_R/V_all_tab_bycol.tsv', header = F,  sep="\t", stringsAsFactors = F)
...
ggsave("/Users/pavel/Desktop/PROJECTS/after_long_break/GC_R/contig_gc_content.pdf",
...
ggsave("/Users/pavel/Desktop/PROJECTS/after_long_break/GC_R/units_gc_content.pdf",
...
ggsave("/Users/pavel/Desktop/PROJECTS/after_long_break/GC_R/contigs_length.pdf",
...
ggsave("/Users/pavel/Desktop/PROJECTS/after_long_break/GC_R/units_length.pdf",
